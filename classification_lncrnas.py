...
classes = {"intronic": 0, "antisense": 0, "intergenic": 0, "convergent": 0,
           "divergent": 0, "sense upstream": 0, "sense downstream": 0,
           "miss": 0}
...
for lnc in distances:
    if lnc[2] == "i":
        ...
        classes["intergenic"] += 1
    elif lnc[1] == lnc[4]:
        if lnc[5] > 0:
            lnc.append("sense downstream")
            classes["sense downstream"] += 1
        elif lnc[5] < 0:
            lnc.append("sense upstream")
            classes["sense upstream"] += 1
    elif lnc[1] != lnc[4]:
        if lnc[5] > 0:
            lnc.append("convergent")
            classes["convergent"] += 1
        elif lnc[5] < 0:
